...
export function createTable({ announce = () => {}, onState = () => {}, rng = Math.random, deckFactory = null, dealerDelay = 900, turnTimeout = 30000, scoreMode = false } = {}) {
  const T = {
    phase: 'lobby',          // lobby | betting | acting | dealer | result
    players: [],             // {id,nick,chips,bet,betConfirmed,hands,handBets,activeHand,handDone,done,results,ready,sitOut,_emoteAt}
